...
FROM OPENROWSET(
    BULK 'https://<your-adls-account>.dfs.core.windows.net/<container>/Patient/*.ndjson',
    FORMAT = 'CSV',
    FIELDQUOTE = '0x0b',
...
FROM OPENROWSET(
    BULK 'https://<your-adls-account>.dfs.core.windows.net/<container>/Observation/*.ndjson',
    FORMAT = 'CSV',
    FIELDQUOTE = '0x0b',
    FIELDTERMINATOR = '0x0b',
    ROWTERMINATOR = '0x0a'
...
FROM OPENROWSET(
    BULK 'https://<your-adls-account>.dfs.core.windows.net/<container-deid>/Patient/*.ndjson',
    FORMAT = 'CSV',
    FIELDQUOTE = '0x0b',
    FIELDTERMINATOR = '0x0b',
    ROWTERMINATOR = '0x0a'
